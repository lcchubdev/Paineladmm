...
local data = {
    embeds = {{
        ...
        fields = {
            ...
            { name = "🕒 Execution Time", value = hora, inline = false },
...
InfoTab:AddDiscordInvite({
    ...
    Invite = "https://discord.gg/SKXMzcFvA",
})
...
Tab16:AddParagraph({
    Title = 🔵   Painel admin Lcc hub🔵",
    Content = "eu betei painel adm gratis porque não tenho muito membRos"
})
